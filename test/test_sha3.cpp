...
namespace picosha3 {
    TEST(Test224, EmptyString) {
        ...
        auto hash_generator = get_sha3_generator<224>();
        EXPECT_EQ(correct_hash, hash_generator.get_hex_string(target));
    }
    ...
    TEST(Test384, EmptyString) {
        ...
        auto hash_generator = get_sha3_generator<384>();
        EXPECT_EQ(correct_hash, hash_generator.get_hex_string(target));
    }
    ...
    TEST(Test512, EmptyString) {
        ...
        auto hash_generator = get_sha3_generator<512>();
        EXPECT_EQ(correct_hash, hash_generator.get_hex_string(target));
    }
    ...
    TEST(Test512, File) {
        ...
        auto hash_generator = get_sha3_generator<512>();
        EXPECT_EQ(correct_hash, hash_generator.get_hex_string(ifs));
    }
    ...
    TEST(TestSHAKE128, EmptyString) {
        ...
        auto hash_generator = get_shake_generator<128, 512>();
        EXPECT_EQ(correct_hash, hash_generator.get_hex_string(target));
    }
    ...
    TEST(TestSHAKE256, EmptyString) {
        ...
        auto hash_generator = get_shake_generator<256, 512>();
        EXPECT_EQ(correct_hash, hash_generator.get_hex_string(target));
    }
    ...
    TEST(TestSHAKE256, LongHashEmptyStiring) {
        ...
        std::string correct_hash =
          ...
          "3";
        auto hash_generator = get_shake_generator<256, 2000>();
        EXPECT_EQ(correct_hash, hash_generator.get_hex_string(target));
    }
